...
function WebpaySimulator() {
  ...
  const handleSuccess = async () => {
    ...
    try {
      ...
      const estadosResponse = await axios.get('http://ferremas-app-env-2.eba-dqgxevfn.us-east-1.elasticbeanstalk.com//api/pedidos/estados');
      ...
      await axios.post('http://ferremas-app-env-2.eba-dqgxevfn.us-east-1.elasticbeanstalk.com//api/pedidos', pedidoData);
      ...
      window.location.href = `http://ferremas-app-env-2.eba-dqgxevfn.us-east-1.elasticbeanstalk.com//api/webpay/commit?token_ws=${token}`;
